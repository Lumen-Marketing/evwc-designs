// Screenshot a band of the full page. node shots/slice.mjs <page> <w> <y> <h> <out>
...
for(let y=0;y<dh;y+=450){await P.evalJS(`scrollTo(0,${y})`);await sleep(80);}
await P.evalJS('scrollTo(0,0)');await sleep(900);
const s=await P.send('Page.captureScreenshot',{format:'png',captureBeyondViewport:true,clip:{x:0,y:Y,width:W,height:H,scale:1}});
